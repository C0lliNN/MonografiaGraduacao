...
\begin{quadro}[H]
    ...
    \textbf{Cenário Principal} & \begin{enumerate}
        \item O cliente informa o nome, \acrshort{cpf} ou \acrshort{cnpj}, e-mail e senha.
