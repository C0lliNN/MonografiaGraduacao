...
O objetivo geral deste trabalho de conclusão de curso é apresentar uma proposta de integração da \acrlong{ams} e \acrlong{ddd} no \english{design} e desenvolvimento visando ganhos de flexibilidade, escalabilidade e em manutenibilidade através de um estudo de caso realista para um sistema de locação de veículos.
...
\item Prover informações relevantes para tomada de decisões técninas com essas tecnologias.
