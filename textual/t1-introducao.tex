...
O objetivo geral deste trabalho de conclusão de curso é apresentar um estudo de caso realista integrando a \acrlong{ams} e \acrlong{ddd} no desenvolvimento de um sistema de locação de veículos. Busca-se demonstrar ganhos de escalabilidade, manutenibilidade e desempenho. Além disso, pretende-se apresentar um guia prático para a utilização adequada dessas duas tecnologias em qualquer contexto.
