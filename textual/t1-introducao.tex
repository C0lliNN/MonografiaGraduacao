...
O objetivo geral deste trabalho de conclusão de curso é apresentar um estudo de caso realista integrando a \acrlong{ams} e \acrlong{ddd}, visando demonstrar ganhos de escalabilidade, manutenibilidade e desempenho a partir de um sistema de locação de veículos.
